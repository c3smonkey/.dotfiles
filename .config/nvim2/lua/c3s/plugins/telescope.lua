return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>jr", "<cmd>Telescope oldfiles<cr>", { desc = "jr Jump to RecentFiles" }) -- find previously opened files
    keymap.set("n", "<leader>ff", "<cmd>Telescope find_files<cr>", { desc = "ff Fuzzy find" }) -- find files within current working directory, respects .gitignore
