...
-- TODO: try to use the same pattern as the above link
return {
	"VonHeikemen/" .. plugin,
	...
	config = function()
		...
		lsp.on_attach(function(_, bufnr)
			...
			vim.keymap.set("n", "<leader>rr", function() vim.lsp.buf.references() end, vim.tbl_deep_extend("force", opts, { desc = "LSP References" }))
